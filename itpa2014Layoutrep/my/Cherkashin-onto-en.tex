...
\item the software should be developed as an open-source project, and
  ...
  users;
\item the software [[should have two implementations: a local and a web form. This will provide the maximum coverage of users of the network as an open or closed.]]
...
\bibitem{kiyoto} Kyoto Cabinet. URL:~\url{http://fallabs.com/kyotocabinet/}
\bibitem{mediawiki}
